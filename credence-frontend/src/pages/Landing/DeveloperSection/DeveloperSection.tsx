    ...
    <section id="developerinfo" className=' w-screen flex mt-10' >
        <div className="developer-section-left h-auto bg-primaryBlack rounded-tr-3xl rounded-br-3xl w-[50%] ">
			<div className="developer-info m-auto p-10 relative z-[1] ">
				...
				<h1 className='text-primaryWhite mt-10 mb-10 text-[3rem] ' >Hi 👋🏻, I am <span className='font-bold text-primaryPurple' >Shivasai</span></h1>
				<p 
					className='text-primaryWhite leading-10 text-lg '
				>
					 Passionate Full Stack Developer with expertise in MERN and Java stacks, 
					 dedicated to crafting end-to-end software solutions. Committed to continuous
					  learning, I thrive on embracing new technologies to stay at the forefront 
					  of innovation. My creative problem-solving skills drive me to tackle complex
					   challenges, ensuring elegant, efficient, and user-centric app designs 
				</p>
				<div className="developer-social-icons mt-7 flex gap-[3rem]">
					<img className='h-12 w-[3rem] bg-primaryWhite rounded-md p-1 hover:cursor-pointer ' src={githubIcon} alt="" />
					<img className='h-12 w-[3rem] bg-primaryWhite rounded-md p-1 hover:cursor-pointer' src={gmailIcon} alt="" />
					<img className='h-12 w-[3rem] bg-primaryWhite rounded-md p-1 hover:cursor-pointer' src={linkedinIcon} alt="" />
				</div>
			</div>
		...
		<div className="developer-info m-auto p-10 flex flex-col items-end relative z-[1] ">
				...
				<div className="developer-social-icons mt-7 flex gap-[3rem]">
					<img className='h-12 w-[3rem] shadow-xl rounded-md p-1 hover:cursor-pointer ' src={githubIcon} alt="" />
					<img className='h-12 w-[3rem] shadow-xl rounded-md p-1 hover:cursor-pointer' src={gmailIcon} alt="" />
					<img className='h-12 w-[3rem] shadow-xl rounded-md p-1 hover:cursor-pointer' src={linkedinIcon} alt="" />
				</div>
			</div>
        </div>
    </section>
