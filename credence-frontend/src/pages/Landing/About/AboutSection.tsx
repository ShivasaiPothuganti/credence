    ...
    <>
      <section className="about h-screen w-screen bg-primaryWhite">
        <div className="about_container h-full w-full flex justify-between gap-10 items-center">
          ...
          <div className="about_container_right h-screen w-[50%] flex justify-center items-center shadow-2xl bg-[#121212] p-5 rounded-three">
            <motion.div
              className="box"
              initial={{ opacity: 0, scale: 0.5 }}
              animate={{ opacity: 1, scale: 1 }}
            ...
            >
              <div className="about_title relative ">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                >
                  <Button className="font-secondary"> Our Services </Button>
                </motion.button>
              </div>
            </motion.div>
          </div>
